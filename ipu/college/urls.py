...
from .views import create_college, college_home, edit_college, college_signup_by_superuser
...
#	url(r'^create/$', create_college, name='create_college'),
	...
	url(r'^signup/$', college_signup_by_superuser, name='college_signup_superuser'),
]
